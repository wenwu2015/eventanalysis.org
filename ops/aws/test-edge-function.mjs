...
function event(uri) {
  return {
    ...
    request: { method: "GET", uri, querystring: {}, headers: { host: { value: "eventanalysis.org" }, "cloudfront-viewer-country": { value: "US" } }, cookies: {} },
  };
}
...
for (const check of checks) {
  ...
  await writeFile(path, JSON.stringify(event(check.uri)));
